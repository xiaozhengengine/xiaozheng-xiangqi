# Xiaozheng, a UCI chess playing engine derived from Stockfish
# Copyright (C) 2004-2022 The Xiaozheng developers (see AUTHORS file)
#
# Xiaozheng is free software: you can redistribute it and/or modify
# it under the terms of the GNU General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# Xiaozheng is distributed in the hope that it will be useful,
...
help:
	@echo ""
	@echo "To compile xiaozheng, type: "
	@echo ""
...
objclean:
	@rm -f xiaozheng xiaozheng.exe *.o ./compression/*.o ./nnue/*.o ./nnue/features/*.o

# clean auxiliary profiling files
profileclean:
	@rm -rf profdir
	@rm -f bench.txt *.gcda *.gcno ./compression/*.gcda ./nnue/*.gcda ./nnue/features/*.gcda *.s
	@rm -f xiaozheng.profdata *.profraw
	@rm -f xiaozheng.*args*
	@rm -f xiaozheng.*lt*
	@rm -f xiaozheng.res
	@rm -f ./-lstdc++.res
...
clang-profile-use:
	$(XCRUN) llvm-profdata merge -output=xiaozheng.profdata *.profraw
	$(MAKE) ARCH=$(ARCH) COMP=$(COMP) \
	EXTRACXXFLAGS='-fprofile-instr-use=xiaozheng.profdata' \
